-- =====================================================
-- Yuan Platform - Frontend Backend Contract (M0) Init SQL
-- Source: docs/api/frontend-backend-contract.md
-- MySQL 8.0+
-- =====================================================
...
CREATE DATABASE IF NOT EXISTS `yuan_platform`
...
-- password_hash for admin123 (bcrypt)
...
SELECT 'yuan_platform initialized (M0 contract).' AS message;
